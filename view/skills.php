                            ...
                            <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col align-self-start">
                                        <div class="card mt-3">
                                            <div class="card-body">
                                                <label class="card-title float-left"
                                                    for="<?php echo $row2->getskills() ?>"><?php echo $row2->getskills() ?>
                                                </label>
                                                <!-- <form method="post">
                                                ...
                                                <input type="range" name="percent[]" class="custom-range" min="0"
                                                    max="100" value="<?php echo $row2->getpercentage() ?>">
