...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user_password = sterilize_input($_SESSION['user']->getpassword());
    ...
    if ($conn->connect_errno) {
        ...
        if ($duplikat == false) {
            ...
            // Update DB
            $insert_query = "UPDATE $table_name SET username='$user_username', password='$user_password', firstName='$user_firstname', lastName='$user_lastname', bdate='$user_dateofbirth', gender='$user_gender', contact='$user_email', phonenum = '$user_phone_number'";
